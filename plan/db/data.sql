...
-- employee data
insert into employee(name,name_kana,department_id) values('高橋','タカハシ',1);
insert into employee(name,name_kana,department_id) values('田中','タナカ',1);
insert into employee(name,name_kana,department_id) values('佐藤','サトウ',1);
